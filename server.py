...
def get_matrix():
    try:
        ...
        print("Fetching matrix data from database")
        delim_data = fetch_collection_as_aligned_list(wwp_delim_col, is_float=False) # Game counts
        prob_data = fetch_collection_as_aligned_list(wwp_prob_col,is_float=True)
